          ...
          <TabsContent value="behavioral" className="space-y-4 mt-6">
            <div className="h-64 w-full">
              {rechartsError ? (
                ...
                (() => {
                  const RC = rechartsComponents as RechartsComponents;
                  return (
                <RC.ResponsiveContainer width="100%" height="100%">
                  <RC.LineChart data={analyticsData?.behavioralPatterns || [
                    ...
                    <RC.XAxis dataKey="time" stroke="#6b7280" fontSize={12} />
                    <RC.YAxis stroke="#6b7280" fontSize={12} />
                    <RC.Line type="monotone" dataKey="normal" stroke="#22c55e" strokeWidth={2} />
                    <RC.Line type="monotone" dataKey="suspicious" stroke="#eab308" strokeWidth={2} />
                    <RC.Line type="monotone" dataKey="anomalies" stroke="#ef4444" strokeWidth={2} />
                  </RC.LineChart>
